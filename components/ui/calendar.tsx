  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: "flex items-center justify-between absolute inset-x-2 top-3 z-10",
        button_previous: cn(
        ...
        selected:
          "!bg-foreground !text-background hover:!bg-foreground hover:!text-background focus:!bg-foreground focus:!text-background rounded-md",
